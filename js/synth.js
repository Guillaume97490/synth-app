      ...
      pad.addEventListener(
        "click", e => {
          if (is_record) {
            ...
            liste.push({
              temps: temps,
              pad2: document.querySelector(`[data-note='${e.target.dataset.note}']`),
            });
          };
        },
        false
...
document.onkeydown = function (e) {
  if (keyAllowed[e.key] === false) return;
...
document.addEventListener("keyup", e => {
  ...
  switch (e.key) {
    case "a": $('[data-note=C4]').removeClass('active'); break;
    case "é": $('[data-note="C#4"]').removeClass('active'); break;
    case "z": $('[data-note=D4]').removeClass('active'); break;
    case '"': $('[data-note="D#4"]').removeClass('active'); break;
    case "e": $('[data-note=E4]').removeClass('active'); break;
    case "r": $('[data-note=F4]').removeClass('active'); break;
    case "(": $('[data-note="F#4"]').removeClass('active'); break;
    case "t": $('[data-note=G4]').removeClass('active'); break;
    case "i": $('[data-note="G#4"]').removeClass('active'); break;
    case "y": $('[data-note=A4]').removeClass('active'); break;
    case "è": $('[data-note="A#4"]').removeClass('active'); break;
    case "u": $('[data-note=B4]').removeClass('active'); break;
    default:
  }
